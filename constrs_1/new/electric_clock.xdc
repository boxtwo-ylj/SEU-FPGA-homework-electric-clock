...
set_property IOSTANDARD LVCMOS33 [get_ports {Key_r[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Key_r[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Key_r[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Key_r[0]}]
set_property PACKAGE_PIN E3 [get_ports {Key_r[0]}]
set_property PACKAGE_PIN G4 [get_ports {Key_r[1]}]
set_property PACKAGE_PIN P19 [get_ports {Key_r[2]}]
set_property PACKAGE_PIN R19 [get_ports {Key_r[3]}]
